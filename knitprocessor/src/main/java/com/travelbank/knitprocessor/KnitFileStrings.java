...
/**
 * Created by travelbank on 2/3/18.
 */

public class KnitFileStrings {

    public static final String KNIT_PACKAGE = "com.travelbank.knit";
    public static final String KNIT = "com.travelbank.knit.Knit";
    public static final String KNIT_CLASS_COMMENT = "This class has been generated by Knit. Do NOT alter it's contents.";

    //PRESENTER
    public static final String KNIT_PRESENTER = "com.travelbank.knit.InternalPresenter";
    ...
    //MODEL
    public static final String KNIT_MODEL = "com.travelbank.knit.InternalModel";
    public static final String KNIT_MODEL_EXT = "com.travelbank.knit.KnitModel";
    ...
    //USER
    public static final String KNIT_USER = "com.travelbank.knit.KnitUser";
    public static final String KNIT_PRESENTER_USER_POSTFIX = "_User";

    //UTILS
    public static final String KNIT_ASYNC_TASK = "com.travelbank.knit.KnitAsyncTaskHandler";
    public static final String KNIT_MODEL_MAP_INTERFACE = "com.travelbank.knit.ModelMapInterface";
    public static final String KNIT_MODEL_MAP = "com.travelbank.knit.ModelMap";
    public static final String KNIT_VIEW_PRESENTER = "ViewToPresenterMap";
    public static final String KNIT_VIEW_PRESENTER_INTERFACE = "com.travelbank.knit.ViewToPresenterMapInterface";
    public static final String KNIT_EVENT_HANDLER = "com.travelbank.knit.viewevents.handlers.EventHandler";
    public static final String KNIT_EVENT_HANDLE_METHOD = "handle";
    public static final String KNIT_EVENT_VIEW_EVENT_POOL = "com.travelbank.knit.viewevents.ViewEventPool";
    public static final String KNIT_EVENT_VIEW_EVENT_ENV = "com.travelbank.knit.viewevents.ViewEventEnv";
    public static final String KNIT_CALLBACK = "com.travelbank.knit.generators.Callback";
    public static final String KNIT_SUBMITTER = "com.travelbank.knit.collectors.Submitter";
    public static final String KNIT_RESPONSE = "com.travelbank.knit.KnitResponse";
    public static final String KNIT_NAVIGATOR = "com.travelbank.knit.KnitNavigator";
    public static final String KNIT_TASK_FLOW = "com.travelbank.knit.schedulers.KnitTaskFlow";
    ...
    public static final ClassName TYPE_NAME_SCHEDULER_PROVIDER = ClassName.bestGuess("com.travelbank.knit.schedulers.SchedulerProvider");
    public static final ClassName TYPE_NAME_CALLABLE = ClassName.bestGuess("java.util.concurrent.Callable");
    public static final ClassName TYPE_NAME_CONSUMER = ClassName.bestGuess("com.travelbank.knit.schedulers.Consumer");
    public static final ClassName TYPE_NAME_SCHEDULER_ENUM = ClassName.bestGuess("com.travelbank.knit.schedulers.KnitSchedulers");
    public static final ClassName TYPE_NAME_KNIT_MESSAGE = ClassName.bestGuess("com.travelbank.knit.KnitMessage");
