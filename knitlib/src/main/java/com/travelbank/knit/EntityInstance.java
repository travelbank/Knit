...
/**
 * Container class for all {@link MemoryEntity} instances registered to {@link com.travelbank.knit.components.graph.UsageGraph}.
...
public class EntityInstance<T extends MemoryEntity> {
     ...
     * Used inside generated {@link InternalModel}s to determine which {@link com.travelbank.knit.generators.ValueGenerator} needs to be accessed
     *
