...
public class KnitUtilsLoader {
    ...
    private static final String KNIT_VIEW_PRESENTER_MAP = "com.travelbank.knit.ViewToPresenterMap";
    private static final String KNIT_MODEL_MAP = "com.travelbank.knit.ModelMap";
