 ...
 * Provides {@link com.omerozer.knit.components.graph.UsageGraph} and the user with lifecycle callbacks.
 *
 * @see com.omerozer.knit.components.graph.UsageGraph
 * @author Omer Ozer
 */
...
public interface MemoryEntity {
     ...
     * @see com.omerozer.knit.components.KnitMemoryManager
     */
    void onMemoryLow();
